...
namespace Ordsome.Services.CrossCuttingConcerns.Languages
{
  ...
  {""id"":95,""code"":""lu"",""name"":""Luba-Katanga"",""nativeName"":""Luba-Katanga""},
  ...
  {""id"":183,""code"":""za"",""name"":""Zhuang, Chuang"",""nativeName"":""Saɯ cueŋƅ, Saw cuengh""}]";
        ...
        private static readonly IEnumerable<LanguageDto> listOfLanguages =
            JsonConvert.DeserializeObject<IEnumerable<LanguageDto>>(json);

        public static LanguageDto GetLanguageById(int id)
        {
            return listOfLanguages.FirstOrDefault(x => x.Id == id);
        }

        public static LanguageDto GetLanguageByCode(string code)
        {
            return listOfLanguages.FirstOrDefault(x => x.LanguageCode == code);
        }
...
//        }
        ...
        public static IEnumerable<LanguageDto> GetList()
        {
